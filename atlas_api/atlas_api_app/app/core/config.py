...
class Settings(BaseSettings):
    ...
    database_url: str = Field(default="sqlite:///./atlas_api.db", alias="ATLAS_DATABASE_URL")
    database_auto_create_schema: bool = Field(default=True, alias="ATLAS_DATABASE_AUTO_CREATE_SCHEMA")
